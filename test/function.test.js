...
test('test replace_fullwidth_and_symbol function',() => {
    let correct_test_answer_1 = crawler.replace_fullwidth_and_symbol("１２３號");
    let correct_test_answer_2 = crawler.replace_fullwidth_and_symbol("123號");
    let correct_test_answer_3 = crawler.replace_fullwidth_and_symbol("123号");
    let correct_test_answer_4 = crawler.replace_fullwidth_and_symbol("1 2 3 號");
    let correct_test_answer_5 = crawler.replace_fullwidth_and_symbol("123號（左邊）");
    let correct_test_answer_6 = crawler.replace_fullwidth_and_symbol("123號[左邊]");
    let correct_test_answer_7 = crawler.replace_fullwidth_and_symbol("基隆路一段32號");
